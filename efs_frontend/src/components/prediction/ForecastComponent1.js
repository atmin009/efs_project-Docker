    ...
    <Container>
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} centered>
        <Modal.Header closeButton>
          <Modal.Title><a style={{ color: 'black', fontFamily: 'Anuphan' }}>เริ่มการพยากรณ์</a></Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <p style={{ color: 'black', fontFamily: 'Anuphan' }}>
  กรุณากดเพื่อเริ่มการพยากรณ์
</p>        </Modal.Body>
        <Modal.Footer>
          <Button
            variant="primary"
            onClick={handleForecast}
            style={{ backgroundColor: "#390042", border: "#390042" ,fontFamily: 'Anuphan'}}
          >
            เริ่มการพยากรณ์
          </Button>
        </Modal.Footer>
